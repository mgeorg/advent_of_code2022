...
class Board(object):
  def __init__(self, lines):
    ...
    self.goal = (self.num_rows-1, self.num_cols-2)
...
while not done:
  ...
  print(f'num_rounds = {num_rounds}  '
        f'({stage1_rounds} + {stage2_rounds} + {stage3_rounds})')
  if num_rounds % 10 == 0:
    print(f'{b}\n')

print(f'{b}\n')
b.possib = {b.goal: Possibility(b, b.goal[0], b.goal[1])}
b.goal = (0, 1)
done = False
while not done:
  done = b.progress()
...
print(f'{b}\n')
b.possib = {b.goal: Possibility(b, b.goal[0], b.goal[1])}
b.goal = (b.num_rows-1, b.num_cols-2)
done = False
while not done:
  done = b.progress()
  num_rounds += 1
